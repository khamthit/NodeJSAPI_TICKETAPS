  ...
  static async changePassword(req, res) {
    try {
      ...
      connected.query(checkPassword, uuid, (err, result) => {
        ...
        const decrypt = CryptoJS.AES.decrypt(result[0]["password"], SECREAT_KEY).toString(CryptoJS.enc.Utf8);
  ...
  static async login(req, res) {
    try {
      ...
      connected.query(checkEmail, email, async (err, result) => {
        ...
        const decryptPassword = CryptoJS.AES.decrypt(result[0]["password"], SECREAT_KEY).toString(CryptoJS.enc.Utf8);
  ...
  static async register(req, res) {
    try {
      ...
      connected.query(checkEmail, email, (errEmail, isMatch) => {
        ...
        connected.query(insert, [uuid, username, phoneNumber, email, genPassword, ROLE.user, datetime, datetime], function (err) {

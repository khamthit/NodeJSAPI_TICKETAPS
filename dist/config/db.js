...
import { DATABASE_NAME, PASSWORD_DATABASE, PORT_DATABASE, URL_DATABASE, USER_DATABASE } from "./globalKey.js";
...
(async () => {
  try {
    ...
    console.log(`Successfully connected to PostgreSQL database: ${DATABASE_NAME} on ${URL_DATABASE}:${PORT_DATABASE}`);
